...
def get_training_args(output_dir: str, phase: int = 1, **overrides: Any) -> TrainingArguments:
...
def check_gpu_availability() -> dict[str, Any]:
    ...
    if info["device_count"] > 0:
        ...
        print(f"  Memory (GPU 0): {allocated:.2f} GB allocated, {reserved:.2f} GB reserved")
