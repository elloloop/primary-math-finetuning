...
def _classify_operation(question: str) -> str:
    ...
    operation_signals: dict[str, list[str]] = {
        "addition": [
            ...
            "more than", "added", "in all",
        ],
        "subtraction": [
            "difference", "left", "remain", "fewer", "less than", "minus",
            "spent", "gave away", "lost", "decrease",
        ],
        "multiplication": [
            "times", "each", "per", "every", "product", "multiplied",
            "twice", "triple", "double",
        ],
        "division": [
            "divided", "split", "shared equally", "per each", "ratio",
            "half", "third", "quarter", "average",
        ],
    }
